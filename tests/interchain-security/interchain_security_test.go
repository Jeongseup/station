...
import (
	...
	appConsumer "github.com/stationlove-ventures/station/app"
...
// NewCoordinator initializes Coordinator with interchain security dummy provider and station consumer chain
