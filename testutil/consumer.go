...
// that allow station chain to be started locally without having to start the provider chain and the relayer.
...
func CreateMinimalConsumerTestGenesis() *ccvconsumertypes.GenesisState {
	...
	genesisState.ProviderClientState.ChainId = "station"
